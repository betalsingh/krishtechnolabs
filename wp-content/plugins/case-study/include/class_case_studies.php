...
if ( ! class_exists( 'CASE_Custom' ) ) {	
	class CASE_Custom {	
		...
		public function casestudies_meta_box_cb() {  
			...
			$case_study_heading1 = !empty($case_study_heading1) ? $case_study_heading1 : __('Casestudy Main Content','aicasestudy');
			$case_study_heading2 = !empty($case_study_heading2) ? $case_study_heading2 : __('Casestudy Bottom Content','aicasestudy') ; 
			...
			<div class="ai_meta_control">	
				...
				<div class="form-field">
					<label for="content_shortdes"><?php _e( 'Short Description:','aicasestudy' ); ?></label>
					<!--<textarea  name="shortdes" maxlength="150" rows="10" cols="400"><?php echo $shortdes;?></textarea>-->
					<?php wp_editor( get_post_meta($post->ID, 'cs_content_shortdes' , true), 'content_shortdes', $settings = array() ); ?>
				</div>  <!-- end .form-field -->			
				<div class="hr"></div>
				
				<!-- About Case Study -->
				<label for="content_aboutcasestudy"><?php _e( 'About Case Study:','aicasestudy' ); ?></label>
				<?php wp_editor( get_post_meta($post->ID, 'cs_content_aboutcasestudy' , true), 'content_aboutcasestudy', $settings = array() ); ?>
				<div class="hr"></div>
						
				<!-- Case Study Content Editor -->
				<label for="the casestudymaincontent"><?php echo $case_study_heading1; ?></label>
				<?php wp_editor( get_post_meta($post->ID, 'cs_content_casestudymaincontent' , true), 'content_casestudymaincontent', $settings = array() ); ?>
				<div class="hr"></div>			
				<!-- Case Study Content Editor -->
				<label for="our casestudybottomcontent"><?php echo $case_study_heading2; ?></label>
				<?php wp_editor( get_post_meta($post->ID, 'cs_content_casestudybottomcontent' , true), 'content_casestudybottomcontent', $settings = array() ); ?>
			</div> <!-- #end main div -->
		<?php }
	...
	<?php }
		...
		// Bail if we're doing an auto save  
			...
			// for Casestudy Main Content
			if( isset( $_POST['content_casestudymaincontent'] ) )
				update_post_meta($post_id, 'cs_content_casestudymaincontent', $_POST['content_casestudymaincontent']);  
			
			// for Casestudy Bottom Content
			if( isset( $_POST['content_casestudybottomcontent'] ) )
				update_post_meta($post_id, 'cs_content_casestudybottomcontent', $_POST['content_casestudybottomcontent']);  
			...
			if( isset( $_POST['content_shortdes'] ) )  
				update_post_meta( $post_id, 'cs_content_shortdes', $_POST['content_shortdes']);

			// for about case study    
			if( isset( $_POST['content_aboutcasestudy'] ) )  
				update_post_meta( $post_id, 'cs_content_aboutcasestudy', $_POST['content_aboutcasestudy']);	  
